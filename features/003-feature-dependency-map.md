---
Document Id: FEAT-DEPS
Title: Карта зависимостей функциональности
...
# Карта зависимостей функциональности
...
Показать, какие фичи зависят друг от друга, чтобы порядок в roadmap/ не нарушал технических и смысловых связей.
...
1. Каждая фича из features/000 присутствует на карте.
2. В графе зависимостей нет циклов.
3. Порядок в roadmap/002-release-plan.md не нарушает эту карту.
