...
| Domain philosophy — направление слоёв | A | `meta/000-documentation-system.md` §6.2 | 1.2.1 |
...
|--------|------|-----------|
| 1.1.3 | 2026-07-29 | PATCH: версия источника класса A строки «Domain philosophy — направление слоёв» обновлена с 1.2.0 до 1.2.1 — цитируемый документ `meta/000-documentation-system.md` существует в редакции 1.2.1. Содержание цитируемого раздела §6.2 не изменялось. Нормативная проза раздела 6 не изменялась; прочие строки таблицы вывода не изменялись. |
| 1.1.2 | 2026-07-29 | PATCH: уточнена запись истории 1.1.1. Ревизия 1.1.1 не только разделила совмещённую строку «Domain philosophy» на две строки по одному классу утверждения, но в том же изменении обновила версию источника класса A этой строки — `meta/000-documentation-system.md` — с 1.0.0 до 1.2.0, поскольку источник и потребитель менялись атомарно в одном коммите. Прослеживаемость приведена в соответствие фактическому источнику. Нормативная проза раздела 6 не изменялась. |
