...
| Кто вы | Что читать |
|--------|------------|
| Новый инженер | [`meta/000-documentation-system.md`](meta/000-documentation-system.md) → далее маршрут в [`meta/001-reading-order.md`](meta/001-reading-order.md), раздел 6.3 |
...
| Слой | Каталог | Вопрос | Характер | Ранг |
|------|---------|--------|----------|------|
...
```
1. meta/000-documentation-system.md      как устроена документация
2. meta/002-authority-model.md           кто главнее при конфликте
3. school/000, school/001                как школа работает сегодня
4. product/000 → 001 → 002 → 003         зачем продукт, границы, роли
5. language/001                          язык продукта
6. domain/000 → domain/001               предметная область
7. experience/001 → 002 → 003            структура, навигация, экраны
8. features/000                          что продукт умеет
9. design/000, design/009                форма и доступность
10. roadmap/001                          первая версия
```
...
**Алгоритм при обнаружении противоречия** ([`meta/002`](meta/002-authority-model.md), раздел 6.3):
...
**Текущее соответствие: уровень не заявлен.** Не автоматизированы проверки, не наполнены реестры терминов и решений. Полный разбор с перечнем непокрытого и четырьмя зарегистрированными отклонениями — [`meta/011-conformance-statement.md`](meta/011-conformance-statement.md).
