---
Document Id: EXP-JRN-STUDENT
Title: Целевой сценарий: путь ученика
...
Описать целевой путь ученика в продукте — от первого входа до регулярного использования, с указанием экранов, событий и ценности на каждом шаге.
