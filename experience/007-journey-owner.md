---
Document Id: EXP-JRN-OWNER
Title: Целевой сценарий: путь руководителя
...
# Целевой сценарий: путь руководителя
...
Описать целевой путь руководителя в продукте — от первого входа до регулярного использования, с указанием экранов, событий и ценности на каждом шаге.
