---
Document Id: EXP-JRN-TEACHER
Title: Целевой сценарий: путь преподавателя
...
# Целевой сценарий: путь преподавателя
...
Описать целевой путь преподавателя в продукте — от первого входа до регулярного использования, с указанием экранов, событий и ценности на каждом шаге.
