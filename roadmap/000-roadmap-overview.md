---
Document Id: RMP-OVERVIEW
Title: Дорожная карта — обзор
...
Must Not Define:
  - Состав релизов (принадлежит roadmap/002)
---
...
Объяснить, как планируется развитие продукта: горизонты, принципы приоритизации, связь с бизнес-целями.
...
1. Принципы приоритизации позволяют сравнить любые две фичи.
2. Каждый горизонт связан с бизнес-целью BG-XX.
