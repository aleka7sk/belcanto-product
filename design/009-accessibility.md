...
Defines:
  - Обязательные требования доступности
  - Целевой уровень соответствия

Must Not Define:
  - Конкретные значения цветов и размеров (принадлежит design/002, design/003)
---
...
Определить обязательные требования доступности продукта — не рекомендации, а условия приёмки любого экрана.
...
1. Указан целевой уровень соответствия и он одинаков во всём репозитории.
2. Каждое требование проверяемо на конкретном экране.
3. Требования покрывают: контраст, размер целей нажатия, альтернативный текст, порядок фокуса, чтение с экрана, уменьшенное движение.
4. Требования являются условием приёмки в governance/002-review-checklist.md.
