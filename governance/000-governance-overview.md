---
Document Id: GOV-OVERVIEW
Title: Управление продуктом — обзор
...
Defines:
  ...
  - Состав слоя governance/

Must Not Define:
  - Сами решения (принадлежит governance/decisions/records/)
---

# Управление продуктом — обзор
...
Объяснить, как принимаются, фиксируются и отменяются продуктовые решения, и почему запись решения важнее самого документа.
...
1. Описан полный путь решения: предложение → обсуждение → запись → применение.
2. Указано, кто имеет право принимать решение по каждому слою.
