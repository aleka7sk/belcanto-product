...
Defines:
  - Правила хранения диаграмм

Must Not Define:
  - Содержание, которое диаграмма иллюстрирует
---
...
Правила хранения диаграмм и требование: диаграмма всегда сопровождает текст, но никогда не заменяет его.
...
1. Каждая диаграмма имеет текстовое описание в документе-владельце.
2. Исходник диаграммы хранится рядом с экспортом.
3. Диаграмма не содержит правил, отсутствующих в тексте.
