...
Must Not Define:
  - Дизайн-решения (принадлежит design/)
---
...
Правила хранения изображений продукта: именование, форматы, связь с документом-владельцем.
...
- [`design/005-iconography.md`](../../design/005-iconography.md)
...
1. Каждое изображение имеет имя по language/002-naming-rules.md.
2. Каждое изображение используется хотя бы в одном документе.
3. Изображение не является единственным носителем правила.
